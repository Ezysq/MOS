...
/*public class Resource{
    ...
    void destroyResource(){
        ...
        void askForResource(Process process){
            // Šį resurso primityvą iškvietęs procesas yra užblokuojamas ir įtraukiamas į resurso laukiančių procesų sąrašą. Šis primityvas kviečia resurso paskirstytoją.
